...
const Carousel = (props) => {
  ...
  const constructVisibleItemsProps = () => {
    ...
    let opacityDivider = (0.1 / elementsInRight); 
  ...
  const loadCarousel = () => {
    return (
      <ul className="carouselWrapper" style={{ height: parentHeight + 'px', width:  parentWidth + 'px', padding: parentPad + 'px', perspective: '300px'}}>
      {
